    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('New', 'Новый'), ('In progress', 'В работе'), ('Completed', 'Завершён')], default='New', max_length=50)),
                ('priority', models.IntegerField(choices=[(1, 'Very high'), (2, 'High'), (3, 'Mediocre'), (4, 'Low'), (5, 'Very low')], default=5)),
